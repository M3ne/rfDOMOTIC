...
linker.cmd: package/cfg/app_ble_pem3.xdl
	$(SED) 's"^\"\(package/cfg/app_ble_pem3cfg.cmd\)\"$""\"C:/ti/simplelink/ble_sdk_2_02_02_25/examples/cc2650lp/simple_ap/ccs/app/FlashROM/configPkg/\1\""' package/cfg/app_ble_pem3.xdl > $@
